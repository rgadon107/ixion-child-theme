 ...
 * Slug: ixion-child/primary-button-group
 * Categories: primary-button-group, button-primary, buttons, featured
 * Sync Status: unsynced
 * Description: A reusable custom button pattern for a single button styled with the color palette and expected behavior.
